...
+ (NSString *) convertForTimeLoggedWithMinutes:(NSInteger) minutes{
    ...
    if(days > 0 && forHours == 0 && forMinutes == 0){
        return [NSString stringWithFormat:@"%ddays",days];
    }else if (days > 0 && forHours != 0 && forMinutes != 0) {
        return [NSString stringWithFormat:@"%ddays %dhours %dminutes",days ,forHours, forMinutes];
    }else if (days > 0 && forHours != 0 && forMinutes == 0){
        return [NSString stringWithFormat:@"%ddays %dhours", days, forHours];
    }else if (days > 0 && forHours == 0 && forMinutes != 0){
        return [NSString stringWithFormat:@"%ddays %dminutes", days, forMinutes];
    }else if (days == 0 && forHours != 0 && forMinutes != 0){
        return [NSString stringWithFormat:@"%dhours %dminutes", forHours, forMinutes];
    }else if (days == 0 && forHours != 0 && forMinutes == 0) {
        return [NSString stringWithFormat:@"%dhours", forHours];
    }else if (days == 0 && forHours == 0 && forMinutes != 0){
        return [NSString stringWithFormat:@"%dminutes", forMinutes];
    }else{
        return @"";
    }
}
...
+ (NSString *) convertTimeLoggedToTimeFormat:(NSInteger)minutes{
    ...
    return [NSString stringWithFormat:@"%d:%.2d", forHours, remainder];
}
...
+ (NSString *)getPhoneStringFromString:(NSString *)numberString
{
    ...
    int first4Digit = number.integerValue / 1000000;
                        ...
                        toLng:(CGFloat )toLng
{
    ...
    urlToOpen = [NSString stringWithFormat:@"comgooglemaps://?saddr=%f,%f&daddr=%f,%f&center=%f,%f&directionsmode=driving&zoom=%d",
                 fromLat,
                 fromLng,
                 toLat,
                 toLng,
