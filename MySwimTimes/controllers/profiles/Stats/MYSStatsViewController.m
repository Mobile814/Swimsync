...
@property (nonatomic, assign) MYSChartView *chartView;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.strokeIndex = [prefs integerForKey:CHART_STROKE];
...
- (void) loadChart
{
    ...
    int numberOfTimes = [prefs integerForKey:CHART_NUMER_OF_TIMES];
...
- (NSMutableArray *) getAllTimes:(MYSProfile *)swimmer
{
    ...
    int count = MIN(aryTimes.count, numberOfTimes);
    
    NSMutableArray *aryChartTimes = [[NSMutableArray alloc] init];
    for (int n = aryTimes.count - count ; n < aryTimes.count ; n ++)
    {
