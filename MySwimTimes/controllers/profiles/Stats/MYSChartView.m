...
@property (nonatomic, assign) UIScrollView *svChart;

@property (nonatomic, assign) UILabel *lblPBTime;
@property (nonatomic, assign) MYSDotLineView *viewPBTimeLine;

@property (nonatomic, assign) UILabel *lblGoalTime;
@property (nonatomic, assign) MYSDotLineView *viewGoalTimeLine;

@property (nonatomic, assign) UILabel *lblCustomTime;
@property (nonatomic, assign) MYSDotLineView *viewCustomTimeLine;

@property (nonatomic, assign) UILabel *lblAnotherPBTime;
@property (nonatomic, assign) MYSDotLineView *viewAnotherPBTimeLine;

@property (nonatomic, retain) MYSGraphView *graphView;
