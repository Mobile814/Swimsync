...
//    MYSLap *lap = [_laps objectAtIndex:indexPath.row];
    MYSLapInfo *currentLap = _currentLaps[indexPath.row];
    cell.lblLapNumber.text = [NSString stringWithFormat:@"%d", indexPath.row + 1];
    ...
    // Set data for cell
//    [cell loadDataForCellWithLap:lap allLaps:_laps];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
        number.frame = CGRectMake(20, 0, 60, 20);
    else
        number.frame = CGRectMake(20, 0, 42, 16);
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
        split.frame = CGRectMake(220, 0, 200, 20);
    else
        split.frame = CGRectMake(97, 0, 78, 16);
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
        total.frame = CGRectMake(500, 0, 200, 20);
    else
        total.frame = CGRectMake(211, 0, 78, 16);
